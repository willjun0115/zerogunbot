...
app.roulette_lst = [
    (":gem:", 2, "상당한 토큰을 얻습니다."),
    (":coin:", 10, "토큰을 조금 얻습니다."),
    (":four_leaf_clover:", 4, "행운 효과를 받습니다."),
    (":smiling_imp:", 6, "토큰을 잃습니다."),
    (":bomb:", 1, "역할을 무작위로 하나 잃습니다."),
    (":skull:", 0.1, "토큰을 모두 잃습니다."),
    (":black_joker:", 0.1, "미보유중인 역할을 모두 얻고 보유중인 역할은 모두 잃습니다."),
    (":arrows_counterclockwise:", 0.2, "무작위 멤버 한 명과 토큰이 뒤바뀝니다."),
    (":busts_in_silhouette:", 0.2, "무작위 멤버 한 명과 역할이 뒤바뀝니다."),
    (":scales:", 0.2, "무작위 멤버 한 명과 토큰을 합쳐 동등하게 나눠 가집니다."),
    (":pick:", 0.2, "무작위 멤버 한 명의 역할을 무작위로 하나 빼앗습니다."),
]
app.shop = {
    "닉변": 200,
    "행운": 50,
